...
describe("ConversationsClient", () => {
    test("listConversations (1)", async () => {
        ...
        const response = await client.unstable.conversations.listConversations({
            per_page: 1,
    ...
    test("listConversations (2)", async () => {
        ...
        await expect(async () => {
            return await client.unstable.conversations.listConversations();
    ...
    test("createConversation (1)", async () => {
        ...
        const response = await client.unstable.conversations.createConversation({
            from: {
                type: "user",
    ...
    test("createConversation (3)", async () => {
        ...
        await expect(async () => {
            return await client.unstable.conversations.createConversation({
                from: {
                    type: "lead",
                    id: "blackcurrant............",
                },
    ...
    test("retrieveConversation (1)", async () => {
        ...
        const response = await client.unstable.conversations.retrieveConversation({
            id: 1,
    ...
    test("retrieveConversation (2)", async () => {
        ...
        await expect(async () => {
            return await client.unstable.conversations.retrieveConversation({
                id: 1,
            });
        }).rejects.toThrow(Intercom.unstable.UnauthorizedError);
    });
    ...
    test("updateConversation (1)", async () => {
        ...
        const response = await client.unstable.conversations.updateConversation({
            id: 1,
            display_as: "plaintext",
            read: true,
            title: "new conversation title",
    ...
    test("updateConversation (4)", async () => {
        ...
        await expect(async () => {
            return await client.unstable.conversations.updateConversation({
                id: 1,
            });
        }).rejects.toThrow(Intercom.unstable.UnauthorizedError);
    });
    ...
    test("deleteConversation (1)", async () => {
        ...
        const response = await client.unstable.conversations.deleteConversation({
            id: 1,
        });
        expect(response).toEqual({
            id: "512",
    ...
    test("deleteConversation (2)", async () => {
        ...
        await expect(async () => {
            return await client.unstable.conversations.deleteConversation({
                id: 1,
            });
        }).rejects.toThrow(Intercom.unstable.UnauthorizedError);
    });
    ...
    test("searchConversations", async () => {
        ...
        const response = await client.unstable.conversations.searchConversations({
            query: {
                operator: "AND",
                value: [
                    {
    ...
    test("replyConversation (1)", async () => {
        ...
        const response = await client.unstable.conversations.replyConversation({
            id: '123 or "last"',
            body: {
                message_type: "comment",
                type: "user",
    ...
    test("replyConversation (6)", async () => {
        ...
        await expect(async () => {
            return await client.unstable.conversations.replyConversation({
                id: "id",
                body: {
                    intercom_user_id: "intercom_user_id",
                    message_type: "comment",
    ...
    test("manageConversation (1)", async () => {
        ...
        const response = await client.unstable.conversations.manageConversation({
            id: "123",
            body: {
                message_type: "close",
                type: "admin",
    ...
    test("manageConversation (6)", async () => {
        ...
        await expect(async () => {
            return await client.unstable.conversations.manageConversation({
                id: "id",
                body: {
                    message_type: "close",
                    type: "admin",
    ...
    test("attachContactToConversation (1)", async () => {
        ...
        const response = await client.unstable.conversations.attachContactToConversation({
            id: "123",
            admin_id: "12345",
            customer: {
    ...
    test("attachContactToConversation (3)", async () => {
        ...
        await expect(async () => {
            return await client.unstable.conversations.attachContactToConversation({
                id: "id",
            });
        }).rejects.toThrow(Intercom.unstable.UnauthorizedError);
    });
    ...
    test("detachContactFromConversation (1)", async () => {
        ...
        const response = await client.unstable.conversations.detachContactFromConversation({
            conversation_id: "123",
            contact_id: "123",
            admin_id: "5017690",
        });
    ...
    test("detachContactFromConversation (5)", async () => {
        ...
        await expect(async () => {
            return await client.unstable.conversations.detachContactFromConversation({
    ...
    test("redactConversation (1)", async () => {
        ...
        const response = await client.unstable.conversations.redactConversation({
            type: "conversation_part",
            conversation_id: "19894788788",
            conversation_part_id: "19381789428",
        });
    ...
    test("redactConversation (3)", async () => {
        ...
        await expect(async () => {
            return await client.unstable.conversations.redactConversation({
                type: "conversation_part",
                conversation_id: "conversation_id",
                conversation_part_id: "conversation_part_id",
            });
    ...
    test("convertConversationToTicket (1)", async () => {
        ...
        const response = await client.unstable.conversations.convertConversationToTicket({
            id: 1,
            ticket_type_id: "53",
        });
        expect(response).toEqual({
    ...
    test("convertConversationToTicket (3)", async () => {
        ...
        await expect(async () => {
            return await client.unstable.conversations.convertConversationToTicket({
                id: 1,
