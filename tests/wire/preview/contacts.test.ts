...
describe("ContactsClient", () => {
    test("listCompaniesForAContact (1)", async () => {
        ...
        const response = await client.preview.contacts.listCompaniesForAContact({
    ...
    test("listCompaniesForAContact (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.contacts.listCompaniesForAContact({
                id: "id",
            });
    ...
    test("listSegmentsForAContact (1)", async () => {
        ...
        const response = await client.preview.contacts.listSegmentsForAContact({
    ...
    test("listSegmentsForAContact (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.contacts.listSegmentsForAContact({
    ...
    test("listSubscriptionsForAContact (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.contacts.listSubscriptionsForAContact({
                contact_id: "contact_id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("listTagsForAContact (1)", async () => {
        ...
        const response = await client.preview.contacts.listTagsForAContact({
            contact_id: "63a07ddf05a32042dffac965",
        });
        expect(response).toEqual({
            type: "list",
    ...
    test("listTagsForAContact (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.contacts.listTagsForAContact({
                contact_id: "contact_id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("ShowContact (1)", async () => {
        ...
        const response = await client.preview.contacts.showContact({
            id: "63a07ddf05a32042dffac965",
        });
        expect(response).toEqual({
            type: "contact",
    ...
    test("ShowContact (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.contacts.showContact({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("UpdateContact (1)", async () => {
        ...
        const response = await client.preview.contacts.updateContact({
            id: "63a07ddf05a32042dffac965",
            email: "joebloggs@intercom.io",
            name: "joe bloggs",
        });
    ...
    test("UpdateContact (3)", async () => {
        ...
        await expect(async () => {
            return await client.preview.contacts.updateContact({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("DeleteContact (1)", async () => {
        ...
        const response = await client.preview.contacts.deleteContact({
            id: "id",
        });
        expect(response).toEqual({
            type: "contact",
    ...
    test("DeleteContact (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.contacts.deleteContact({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("MergeContact (1)", async () => {
        ...
        const response = await client.preview.contacts.mergeContact({
    ...
    test("MergeContact (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.contacts.mergeContact();
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("SearchContacts (1)", async () => {
        ...
        const response = await client.preview.contacts.searchContacts({
            query: {
                operator: "AND",
                value: [
                    {
    ...
    test("SearchContacts (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.contacts.searchContacts({
                query: {},
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("ListContacts (1)", async () => {
        ...
        const response = await client.preview.contacts.listContacts();
        expect(response).toEqual({
            type: "list",
            data: [
                {
    ...
    test("ListContacts (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.contacts.listContacts();
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("CreateContact (1)", async () => {
        ...
        const response = await client.preview.contacts.createContact({
            email: "joebloggs@intercom.io",
        });
        expect(response).toEqual({
            type: "contact",
    ...
    test("CreateContact (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.contacts.createContact({
                key: "value",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("ShowContactByExternalId (1)", async () => {
        ...
        const response = await client.preview.contacts.showContactByExternalId({
    ...
    test("ShowContactByExternalId (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.contacts.showContactByExternalId({
    ...
    test("ArchiveContact", async () => {
        ...
        const response = await client.preview.contacts.archiveContact({
            id: "63a07ddf05a32042dffac965",
        });
        expect(response).toEqual({
            type: "contact",
    ...
    test("UnarchiveContact", async () => {
        ...
        const response = await client.preview.contacts.unarchiveContact({
            id: "63a07ddf05a32042dffac965",
        });
        expect(response).toEqual({
            type: "contact",
    ...
    test("BlockContact", async () => {
        ...
        const response = await client.preview.contacts.blockContact({
            id: "63a07ddf05a32042dffac965",
        });
        expect(response).toEqual({
            type: "contact",
