...
describe("VisitorsClient", () => {
    test("retrieveVisitorWithUserId (1)", async () => {
        ...
        const response = await client.preview.visitors.retrieveVisitorWithUserId({
            user_id: "user_id",
        });
    ...
    test("retrieveVisitorWithUserId (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.visitors.retrieveVisitorWithUserId({
                user_id: "user_id",
            });
    ...
    test("updateVisitor (1)", async () => {
        ...
        const response = await client.preview.visitors.updateVisitor({
            id: "6762f30c1bb69f9f2193bc5e",
            name: "Gareth Bale",
        });
        expect(response).toEqual({
    ...
    test("updateVisitor (3)", async () => {
        ...
        await expect(async () => {
            return await client.preview.visitors.updateVisitor({
                key: "value",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("convertVisitor (1)", async () => {
        ...
        const response = await client.preview.visitors.convertVisitor({
            type: "user",
            user: {
                email: "foo@bar.com",
            },
    ...
    test("convertVisitor (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.visitors.convertVisitor({
                type: "type",
                user: {
                    key: "value",
                },
