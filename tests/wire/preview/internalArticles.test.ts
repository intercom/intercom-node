...
describe("InternalArticlesClient", () => {
    test("listInternalArticles (1)", async () => {
        ...
        const response = await client.preview.internalArticles.listInternalArticles();
    ...
    test("listInternalArticles (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.internalArticles.listInternalArticles();
    ...
    test("createInternalArticle (1)", async () => {
        ...
        const response = await client.preview.internalArticles.createInternalArticle({
            title: "Thanks for everything",
            body: "Body of the Article",
            author_id: 991266252,
            owner_id: 991266252,
    ...
    test("createInternalArticle (3)", async () => {
        ...
        await expect(async () => {
            return await client.preview.internalArticles.createInternalArticle(undefined);
    ...
    test("retrieveInternalArticle (1)", async () => {
        ...
        const response = await client.preview.internalArticles.retrieveInternalArticle({
            id: 1,
        });
        expect(response).toEqual({
            type: "internal_article",
    ...
    test("retrieveInternalArticle (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.internalArticles.retrieveInternalArticle({
                id: 1,
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("updateInternalArticle (1)", async () => {
        ...
        const response = await client.preview.internalArticles.updateInternalArticle({
            id: 1,
    ...
    test("updateInternalArticle (3)", async () => {
        ...
        await expect(async () => {
            return await client.preview.internalArticles.updateInternalArticle({
                id: 1,
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("deleteInternalArticle (1)", async () => {
        ...
        const response = await client.preview.internalArticles.deleteInternalArticle({
            id: 1,
        });
        expect(response).toEqual({
            id: "51",
    ...
    test("deleteInternalArticle (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.internalArticles.deleteInternalArticle({
                id: 1,
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("searchInternalArticles (1)", async () => {
        ...
        const response = await client.preview.internalArticles.searchInternalArticles({
            folder_id: 1,
        });
        expect(response).toEqual({
            type: "list",
    ...
    test("searchInternalArticles (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.internalArticles.searchInternalArticles();
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
});
