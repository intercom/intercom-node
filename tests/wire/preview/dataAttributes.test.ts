...
describe("DataAttributesClient", () => {
    test("lisDataAttributes (1)", async () => {
        ...
        const response = await client.preview.dataAttributes.lisDataAttributes({
            model: "contact",
    ...
    test("lisDataAttributes (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.dataAttributes.lisDataAttributes();
    ...
    test("createDataAttribute (1)", async () => {
        ...
        const response = await client.preview.dataAttributes.createDataAttribute({
            key: "value",
        });
        expect(response).toEqual({
            type: "data_attribute",
    ...
    test("createDataAttribute (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.dataAttributes.createDataAttribute({
                key: "value",
            });
    ...
    test("updateDataAttribute (1)", async () => {
        ...
        const response = await client.preview.dataAttributes.updateDataAttribute({
            id: 1,
            body: {
                key: "value",
            },
    ...
    test("updateDataAttribute (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.dataAttributes.updateDataAttribute({
                id: 1,
                body: {
                    key: "value",
                },
