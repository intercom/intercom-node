...
describe("NewsClient", () => {
    test("listNewsItems (1)", async () => {
        ...
        const response = await client.preview.news.listNewsItems();
    ...
    test("listNewsItems (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.news.listNewsItems();
    ...
    test("createNewsItem (1)", async () => {
        ...
        const response = await client.preview.news.createNewsItem({
            title: "Halloween is here!",
            body: "<p>New costumes in store for this spooky season</p>",
            sender_id: 991267834,
            state: "live",
    ...
    test("createNewsItem (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.news.createNewsItem({
                title: "title",
                sender_id: 1,
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    ...
    test("retrieveNewsItem (1)", async () => {
        ...
        const response = await client.preview.news.retrieveNewsItem({
            id: 1,
        });
        expect(response).toEqual({
            type: "news-item",
    ...
    test("retrieveNewsItem (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.news.retrieveNewsItem({
                id: 1,
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("updateNewsItem (1)", async () => {
        ...
        const response = await client.preview.news.updateNewsItem({
            id: 1,
            body: {
                title: "Christmas is here!",
                body: "<p>New gifts in store for the jolly season</p>",
    ...
    test("updateNewsItem (3)", async () => {
        ...
        await expect(async () => {
            return await client.preview.news.updateNewsItem({
                id: 1,
                body: {
                    title: "title",
                    sender_id: 1,
    ...
    test("deleteNewsItem (1)", async () => {
        ...
        const response = await client.preview.news.deleteNewsItem({
            id: 1,
        });
        expect(response).toEqual({
            id: "40",
    ...
    test("deleteNewsItem (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.news.deleteNewsItem({
                id: 1,
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("listLiveNewsfeedItems (1)", async () => {
        ...
        const response = await client.preview.news.listLiveNewsfeedItems({
            id: "123",
        });
        expect(response).toEqual({
            type: "list",
    ...
    test("listLiveNewsfeedItems (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.news.listLiveNewsfeedItems({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("listNewsfeeds (1)", async () => {
        ...
        const response = await client.preview.news.listNewsfeeds();
        expect(response).toEqual({
            type: "list",
            pages: {
                type: "pages",
    ...
    test("listNewsfeeds (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.news.listNewsfeeds();
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("retrieveNewsfeed (1)", async () => {
        ...
        const response = await client.preview.news.retrieveNewsfeed({
            id: "123",
        });
        expect(response).toEqual({
            id: "72",
    ...
    test("retrieveNewsfeed (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.news.retrieveNewsfeed({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
