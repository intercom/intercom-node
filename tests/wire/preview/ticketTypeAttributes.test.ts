...
describe("TicketTypeAttributesClient", () => {
    test("createTicketTypeAttribute (1)", async () => {
        ...
        const response = await client.preview.ticketTypeAttributes.createTicketTypeAttribute({
    ...
    test("createTicketTypeAttribute (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.ticketTypeAttributes.createTicketTypeAttribute({
                ticket_type_id: "ticket_type_id",
                name: "name",
    ...
    test("updateTicketTypeAttribute (1)", async () => {
        ...
        const response = await client.preview.ticketTypeAttributes.updateTicketTypeAttribute({
            ticket_type_id: "ticket_type_id",
            id: "id",
            description: "New Attribute Description",
        });
    ...
    test("updateTicketTypeAttribute (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.ticketTypeAttributes.updateTicketTypeAttribute({
                ticket_type_id: "ticket_type_id",
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
