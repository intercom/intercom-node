...
describe("DataEventsClient", () => {
    test("lisDataEvents (1)", async () => {
        ...
        const response = await client.preview.dataEvents.lisDataEvents({
            filter: {
                user_id: "user_id",
            },
            type: "type",
    ...
    test("lisDataEvents (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.dataEvents.lisDataEvents({
                filter: {
                    user_id: "user_id",
                },
                type: "type",
    ...
    test("createDataEvent (1)", async () => {
        ...
        const response = await client.preview.dataEvents.createDataEvent({
            key: "value",
        });
    ...
    test("createDataEvent (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.dataEvents.createDataEvent({
                key: "value",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("dataEventSummaries (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.dataEvents.dataEventSummaries();
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
});
