...
describe("MessagesClient", () => {
    test("createMessage (1)", async () => {
        ...
        const response = await client.preview.messages.createMessage({
            from: {
                type: "user",
    ...
    test("createMessage (10)", async () => {
        ...
        await expect(async () => {
            return await client.preview.messages.createMessage(undefined);
    ...
    test("getWhatsAppMessageStatus (1)", async () => {
        ...
        const response = await client.preview.messages.getWhatsAppMessageStatus({
            ruleset_id: "ruleset_id",
            per_page: 1,
    ...
    test("getWhatsAppMessageStatus (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.messages.getWhatsAppMessageStatus({
                ruleset_id: "ruleset_id",
            });
        }).rejects.toThrow(Intercom.preview.BadRequestError);
    });
    ...
    test("getWhatsAppMessageStatus (5)", async () => {
        ...
        }).rejects.toThrow(Intercom.preview.InternalServerError);
    });

    test("RetrieveWhatsAppMessageStatus (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
        ...
        server
            .mockEndpoint()
            .get("/messages/whatsapp/status")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.preview.messages.retrieveWhatsAppMessageStatus({
    ...
    test("RetrieveWhatsAppMessageStatus (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
        ...
        const rawResponseBody = {
            ...
            template_name: "appointment_reminder",
            message_id: "wamid_abc123",
            error: { message: "Message delivery failed", details: "Recipient phone number not on WhatsApp" },
        };
        server
            .mockEndpoint()
            .get("/messages/whatsapp/status")
    ...
    test("RetrieveWhatsAppMessageStatus (3)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
        ...
        await expect(async () => {
            return await client.preview.messages.retrieveWhatsAppMessageStatus({
                message_id: "message_id",
            });
        }).rejects.toThrow(Intercom.preview.BadRequestError);
    });

    test("RetrieveWhatsAppMessageStatus (4)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
    ...
    test("RetrieveWhatsAppMessageStatus (5)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
