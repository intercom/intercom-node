...
describe("CompaniesClient", () => {
    test("retrieveCompany (1)", async () => {
        ...
        const response = await client.preview.companies.retrieveCompany({
            name: "my company",
            company_id: "12345",
            tag_id: "678910",
            segment_id: "98765",
    ...
    test("retrieveCompany (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.companies.retrieveCompany();
    ...
    test("createOrUpdateCompany (1)", async () => {
        ...
        const response = await client.preview.companies.createOrUpdateCompany({
            key: "value",
        });
        expect(response).toEqual({
            type: "company",
    ...
    test("createOrUpdateCompany (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.companies.createOrUpdateCompany({
                key: "value",
            });
    ...
    test("RetrieveACompanyById (1)", async () => {
        ...
        const response = await client.preview.companies.retrieveACompanyById({
    ...
    test("RetrieveACompanyById (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.companies.retrieveACompanyById({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("UpdateCompany (1)", async () => {
        ...
        const response = await client.preview.companies.updateCompany({
            id: "5f4d3c1c-7b1b-4d7d-a97e-6095715c6632",
        });
        expect(response).toEqual({
            type: "company",
    ...
    test("UpdateCompany (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.companies.updateCompany({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("deleteCompany (1)", async () => {
        ...
        const response = await client.preview.companies.deleteCompany({
            id: "5f4d3c1c-7b1b-4d7d-a97e-6095715c6632",
        });
        expect(response).toEqual({
    ...
    test("deleteCompany (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.companies.deleteCompany({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("listAllCompanies (1)", async () => {
        ...
        const response = await client.preview.companies.listAllCompanies({
            page: 1,
            per_page: 1,
            order: "desc",
        });
    ...
    test("listAllCompanies (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.companies.listAllCompanies();
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("scrollOverAllCompanies (1)", async () => {
        ...
        const response = await client.preview.companies.scrollOverAllCompanies({
    ...
    test("scrollOverAllCompanies (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.companies.scrollOverAllCompanies();
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("attachContactToACompany (1)", async () => {
        ...
        const response = await client.preview.companies.attachContactToACompany({
            id: "id",
    ...
    test("attachContactToACompany (4)", async () => {
        ...
        await expect(async () => {
            return await client.preview.companies.attachContactToACompany({
                id: "id",
                company_id: "company_id",
            });
        }).rejects.toThrow(Intercom.preview.BadRequestError);
