...
describe("CallsClient", () => {
    test("listCalls (1)", async () => {
        ...
        const response = await client.preview.calls.listCalls({
            page: 1,
            per_page: 1,
        });
    ...
    test("listCalls (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.calls.listCalls();
    ...
    test("showCall (1)", async () => {
        ...
        const response = await client.preview.calls.showCall({
            id: "id",
        });
        expect(response).toEqual({
            type: "call",
    ...
    test("showCall (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.calls.showCall({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("listCallsWithTranscripts (1)", async () => {
        ...
        const response = await client.preview.calls.listCallsWithTranscripts({
    ...
    test("listCallsWithTranscripts (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.calls.listCallsWithTranscripts({
    ...
    test("registerFinVoiceCall (1)", async () => {
        ...
        const response = await client.preview.calls.registerFinVoiceCall({
    ...
    test("registerFinVoiceCall (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.calls.registerFinVoiceCall(undefined);
        }).rejects.toThrow(Intercom.preview.BadRequestError);
    });
    ...
    test("collectFinVoiceCallByExternalId (1)", async () => {
        ...
        const response = await client.preview.calls.collectFinVoiceCallByExternalId({
    ...
    test("collectFinVoiceCallByExternalId (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.calls.collectFinVoiceCallByExternalId({
                external_id: "external_id",
            });
        }).rejects.toThrow(Intercom.preview.NotFoundError);
    });
    ...
    test("collectFinVoiceCallByPhoneNumber (1)", async () => {
        ...
        const response = await client.preview.calls.collectFinVoiceCallByPhoneNumber({
    ...
    test("collectFinVoiceCallByPhoneNumber (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.calls.collectFinVoiceCallByPhoneNumber({
                phone_number: "phone_number",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("collectFinVoiceCallsByConversationId (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
        ...
        const response = await client.preview.calls.collectFinVoiceCallsByConversationId({
    ...
    test("collectFinVoiceCallsByConversationId (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
        ...
        await expect(async () => {
            return await client.preview.calls.collectFinVoiceCallsByConversationId({
                conversation_id: "conversation_id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
