...
describe("NotesClient", () => {
    test("listCompanyNotes (1)", async () => {
            ...
            data: [
                {
                    ...
                    company: { type: "company", id: "5f4d3c1c-7b1b-4d7d-a97e-6095715c6632" },
                    author: {
                        type: "admin",
                        id: "991267581",
                        name: "Ciaran122 Lee",
        ...
        const response = await client.preview.notes.listCompanyNotes({
    ...
    test("listCompanyNotes (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.notes.listCompanyNotes({
                company_id: "company_id",
            });
        }).rejects.toThrow(Intercom.preview.NotFoundError);
    });

    test("createCompanyNote (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
        ...
        const rawRequestBody = { body: "Hello", admin_id: "991267583" };
        const rawResponseBody = {
            type: "note",
            id: "31",
            created_at: 1734537390,
            contact: { type: "type", id: "214656d0c743eafcfde7f248" },
            company: { type: "company", id: "5f4d3c1c-7b1b-4d7d-a97e-6095715c6632" },
            author: {
                type: "admin",
                id: "991267583",
        ...
        server
            .mockEndpoint()
            .post("/companies/5f4d3c1c-7b1b-4d7d-a97e-6095715c6632/notes")
        ...
        const response = await client.preview.notes.createCompanyNote({
            company_id: "5f4d3c1c-7b1b-4d7d-a97e-6095715c6632",
            body: "Hello",
            admin_id: "991267583",
        });
    ...
    test("createCompanyNote (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
    ...
    test("createCompanyNote (3)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
        ...
        const rawRequestBody = { body: "Hello" };
        const rawResponseBody = {
            type: "note",
            id: "31",
            created_at: 1734537390,
    ...
    test("createCompanyNote (4)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
        ...
        await expect(async () => {
            return await client.preview.notes.createCompanyNote({
                company_id: "company_id",
                body: "body",
            });
    ...
    test("createCompanyNote (5)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
    ...
    test("listNotes (1)", async () => {
            ...
            data: [
                {
                    ...
                    company: { id: "5f4d3c1c-7b1b-4d7d-a97e-6095715c6632" },
                    author: {
                        type: "admin",
                        id: "991267581",
                        name: "Ciaran122 Lee",
        ...
        const response = await client.preview.notes.listNotes({
            id: 1,
        });
        expect(response).toEqual({
            type: "list",
    ...
    test("listNotes (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.notes.listNotes({
                id: 1,
            });
        }).rejects.toThrow(Intercom.preview.NotFoundError);
    });
    ...
    test("createNote (1)", async () => {
        ...
        const rawResponseBody = {
            ...
            company: { type: "type", id: "5f4d3c1c-7b1b-4d7d-a97e-6095715c6632" },
            author: {
                type: "admin",
                id: "991267583",
                name: "Ciaran124 Lee",
        ...
        const response = await client.preview.notes.createNote({
            id: 1,
            body: "Hello",
    ...
    test("createNote (4)", async () => {
        ...
        await expect(async () => {
            return await client.preview.notes.createNote({
                id: 1,
                body: "body",
            });
        }).rejects.toThrow(Intercom.preview.NotFoundError);
