...
describe("TicketTypesClient", () => {
    ...
    test("listTicketTypes (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.ticketTypes.listTicketTypes();
    ...
    test("createTicketType (1)", async () => {
        ...
        const response = await client.preview.ticketTypes.createTicketType({
            key: "value",
        });
        expect(response).toEqual({
            type: "type",
    ...
    test("createTicketType (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.ticketTypes.createTicketType({
                key: "value",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("getTicketType (1)", async () => {
        ...
        const response = await client.preview.ticketTypes.getTicketType({
            id: "id",
        });
        expect(response).toEqual({
            type: "ticket_type",
    ...
    test("getTicketType (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.ticketTypes.getTicketType({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
