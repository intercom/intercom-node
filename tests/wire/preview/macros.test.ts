...
describe("MacrosClient", () => {
    test("listMacros (1)", async () => {
        ...
        const response = await client.preview.macros.listMacros({
            per_page: 1,
    ...
    test("listMacros (7)", async () => {
        ...
        await expect(async () => {
            return await client.preview.macros.listMacros();
    ...
    test("getMacro (1)", async () => {
        ...
        const response = await client.preview.macros.getMacro({
            id: "123",
        });
        expect(response).toEqual({
            type: "macro",
    ...
    test("getMacro (5)", async () => {
        ...
        await expect(async () => {
            return await client.preview.macros.getMacro({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
