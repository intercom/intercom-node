...
describe("HelpCenterClient", () => {
    ...
    test("listAllCollections (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.helpCenter.listAllCollections();
    ...
    test("createCollection (1)", async () => {
        ...
        const response = await client.preview.helpCenter.createCollection({
            name: "Thanks for everything",
        });
        expect(response).toEqual({
            id: "165",
    ...
    test("createCollection (3)", async () => {
        ...
        await expect(async () => {
            return await client.preview.helpCenter.createCollection({
                name: "name",
            });
    ...
    test("retrieveCollection (1)", async () => {
        ...
        const response = await client.preview.helpCenter.retrieveCollection({
            id: 1,
        });
        expect(response).toEqual({
            id: "170",
    ...
    test("retrieveCollection (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.helpCenter.retrieveCollection({
                id: 1,
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("updateCollection (1)", async () => {
        ...
        const response = await client.preview.helpCenter.updateCollection({
            id: 1,
            name: "Update collection name",
        });
        expect(response).toEqual({
    ...
    test("updateCollection (3)", async () => {
        ...
        await expect(async () => {
            return await client.preview.helpCenter.updateCollection({
                id: 1,
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("retrieveHelpCenter (1)", async () => {
        ...
        const response = await client.preview.helpCenter.retrieveHelpCenter({
            id: 1,
        });
        expect(response).toEqual({
            id: "93",
    ...
    test("retrieveHelpCenter (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.helpCenter.retrieveHelpCenter({
                id: 1,
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("listHelpCenters (1)", async () => {
        ...
        const response = await client.preview.helpCenter.listHelpCenters();
        expect(response).toEqual({
            type: "list",
            data: [
                {
    ...
    test("listHelpCenters (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.helpCenter.listHelpCenters();
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
});
