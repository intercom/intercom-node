...
describe("TicketsClient", () => {
    test("replyTicket (1)", async () => {
        ...
        const response = await client.preview.tickets.replyTicket({
            id: "123",
            body: {
                message_type: "comment",
                type: "user",
    ...
    test("replyTicket (6)", async () => {
        ...
        await expect(async () => {
            return await client.preview.tickets.replyTicket({
                id: "id",
                body: {
                    intercom_user_id: "intercom_user_id",
                    message_type: "comment",
    ...
    test("enqueueCreateTicket (1)", async () => {
        ...
        const response = await client.preview.tickets.enqueueCreateTicket({
            ticket_type_id: "1234",
            contacts: [
                {
    ...
    test("enqueueCreateTicket (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.tickets.enqueueCreateTicket({
    ...
    test("getTicket (1)", async () => {
        ...
        const rawResponseBody = {
            ...
            ticket_attributes: { _default_title_: "attribute_value", _default_description_: "ticket_attributes" },
            ticket_state: {
                type: "ticket_state",
                id: "8537",
                category: "submitted",
    ...
    test("getTicket (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.tickets.getTicket({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });

    test("updateTicket (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
        ...
        const response = await client.preview.tickets.updateTicket({
            id: "id",
            ticket_attributes: {
    ...
    test("updateTicket (5)", async () => {
        ...
        await expect(async () => {
            return await client.preview.tickets.updateTicket({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.BadRequestError);
    });

    test("updateTicket (6)", async () => {
        const server = mockServerPool.createServer();
        const client = new IntercomClient({
            maxRetries: 0,
            token: "test",
    ...
    test("deleteTicket (1)", async () => {
        ...
        server.mockEndpoint().delete("/tickets/id").respondWith().statusCode(200).jsonBody(rawResponseBody).build();
    ...
    test("deleteTicket (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.tickets.deleteTicket({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("deleteTicket (4)", async () => {
        ...
        const rawResponseBody = { key: "value" };
        server.mockEndpoint().delete("/tickets/id").respondWith().statusCode(404).jsonBody(rawResponseBody).build();
    ...
    test("changeTicketType (1)", async () => {
        ...
        const rawRequestBody = { ticket_type_id: "1234", ticket_state_id: "5678" };
        const rawResponseBody = {
            type: "ticket",
            id: "494",
            ticket_id: "53",
            category: "Back-office",
            ticket_attributes: { _default_title_: "example", _default_description_: "having a problem" },
            ticket_state: {
                type: "ticket_state",
                id: "12",
                category: "submitted",
            ...
            contacts: {
                type: "contact.list",
                contacts: [{ type: "contact", id: "667d61c88a68186f43bafe93", external_id: "71" }],
            },
            admin_assignee_id: 0,
            team_assignee_id: 0,
            created_at: 1719493065,
        ...
        const response = await client.preview.tickets.changeTicketType({
            ticket_id: "ticket_id",
            ticket_type_id: "1234",
    ...
    test("changeTicketType (2)", async () => {
        ...
        const rawRequestBody = { ticket_type_id: "ticket_type_id", ticket_state_id: "ticket_state_id" };
        const rawResponseBody = { key: "value" };
        server
            .mockEndpoint()
            .post("/tickets/ticket_id/change_type")
        ...
        await expect(async () => {
            return await client.preview.tickets.changeTicketType({
                ticket_id: "ticket_id",
                ticket_type_id: "ticket_type_id",
    ...
    test("searchTickets", async () => {
            ...
            tickets: [
                {
                    ...
                    ticket_id: "40",
                    category: "Back-office",
                    ticket_attributes: { _default_title_: "attribute_value", _default_description_: undefined },
                    ticket_state: {
                        type: "ticket_state",
                        id: "8577",
                        category: "submitted",
        ...
        const response = await client.preview.tickets.searchTickets({
            query: {
                operator: "AND",
                value: [
                    {
