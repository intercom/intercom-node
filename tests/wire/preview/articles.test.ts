...
describe("ArticlesClient", () => {
    test("listArticles (1)", async () => {
        ...
        const response = await client.preview.articles.listArticles();
    ...
    test("listArticles (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.articles.listArticles();
    ...
    test("createArticle (1)", async () => {
        ...
        const rawResponseBody = {
            ...
            tags: {
                type: "tag.list",
                tags: [
                    { type: "type", id: "id", name: "name", applied_at: 1, applied_by: { type: "type", id: "id" } },
                    { type: "type", id: "id", name: "name", applied_at: 1, applied_by: { type: "type", id: "id" } },
                ],
            },
            folder_id: 1,
        ...
        const response = await client.preview.articles.createArticle({
            key: "value",
        });
        expect(response).toEqual({
            statistics: {
    ...
    test("createArticle (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.articles.createArticle({
                key: "value",
            });
    ...
    test("retrieveArticle (1)", async () => {
        ...
        const response = await client.preview.articles.retrieveArticle({
            id: 1,
        });
        expect(response).toEqual({
            type: "article",
    ...
    test("retrieveArticle (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.articles.retrieveArticle({
                id: 1,
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("deleteArticle (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.articles.deleteArticle({
                id: 1,
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("searchArticles (1)", async () => {
        ...
        const response = await client.preview.articles.searchArticles({
    ...
    test("searchArticles (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.articles.searchArticles();
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
});
