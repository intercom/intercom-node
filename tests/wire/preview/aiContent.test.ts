...
describe("AiContentClient", () => {
    test("listContentImportSources (1)", async () => {
        ...
        const response = await client.preview.aiContent.listContentImportSources();
    ...
    test("listContentImportSources (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.aiContent.listContentImportSources();
    ...
    test("createContentImportSource (1)", async () => {
        ...
        const response = await client.preview.aiContent.createContentImportSource({
            url: "https://www.example.com",
        });
        expect(response).toEqual({
            type: "content_import_source",
    ...
    test("createContentImportSource (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.aiContent.createContentImportSource({
                url: "url",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("deleteContentImportSource (1)", async () => {
        ...
        const response = await client.preview.aiContent.deleteContentImportSource({
            id: "id",
        });
    ...
    test("deleteContentImportSource (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.aiContent.deleteContentImportSource({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("listExternalPages (1)", async () => {
        ...
        const response = await client.preview.aiContent.listExternalPages();
        expect(response).toEqual({
            type: "list",
            pages: {
                type: "pages",
    ...
    test("listExternalPages (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.aiContent.listExternalPages();
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("createExternalPage (1)", async () => {
        ...
        const response = await client.preview.aiContent.createExternalPage({
            title: "Test",
            html: "<html><body><h1>Test</h1></body></html>",
            url: "https://www.example.com",
            source_id: 44,
    ...
    test("createExternalPage (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.aiContent.createExternalPage({
                title: "title",
                html: "html",
                source_id: 1,
    ...
    test("getExternalPage (1)", async () => {
        ...
        const response = await client.preview.aiContent.getExternalPage({
            id: "id",
        });
        expect(response).toEqual({
            type: "external_page",
    ...
    test("getExternalPage (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.aiContent.getExternalPage({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
    ...
    test("updateExternalPage (1)", async () => {
        ...
        const response = await client.preview.aiContent.updateExternalPage({
            id: "id",
            title: "Test",
            html: "<html><body><h1>Test</h1></body></html>",
            url: "https://www.example.com",
    ...
    test("updateExternalPage (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.aiContent.updateExternalPage({
                id: "id",
                title: "title",
                html: "html",
                url: "url",
    ...
    test("deleteExternalPage (1)", async () => {
        ...
        const response = await client.preview.aiContent.deleteExternalPage({
            id: "id",
        });
        expect(response).toEqual({
            type: "external_page",
    ...
    test("deleteExternalPage (2)", async () => {
        ...
        await expect(async () => {
            return await client.preview.aiContent.deleteExternalPage({
                id: "id",
            });
        }).rejects.toThrow(Intercom.preview.UnauthorizedError);
    });
