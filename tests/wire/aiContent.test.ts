...
describe("AiContentClient", () => {
    test("listContentImportSources (1)", async () => {
        ...
        const response = await client.aiContent.listContentImportSources();
    ...
    test("listContentImportSources (2)", async () => {
        ...
        await expect(async () => {
            return await client.aiContent.listContentImportSources();
    ...
    test("createContentImportSource (2)", async () => {
        ...
        await expect(async () => {
            return await client.aiContent.createContentImportSource({
                url: "url",
            });
        }).rejects.toThrow(Intercom.UnauthorizedError);
    });
    ...
    test("getContentImportSource (2)", async () => {
        ...
        await expect(async () => {
            return await client.aiContent.getContentImportSource({
                source_id: "source_id",
            });
        }).rejects.toThrow(Intercom.UnauthorizedError);
    });
    ...
    test("updateContentImportSource (2)", async () => {
        ...
        await expect(async () => {
            return await client.aiContent.updateContentImportSource({
                source_id: "source_id",
                sync_behavior: "api",
                url: "url",
            });
    ...
    test("deleteContentImportSource (1)", async () => {
        ...
        server.mockEndpoint().delete("/ai/content_import_sources/source_id").respondWith().statusCode(200).build();

        const response = await client.aiContent.deleteContentImportSource({
            source_id: "source_id",
        });
    ...
    test("deleteContentImportSource (2)", async () => {
        ...
        await expect(async () => {
            return await client.aiContent.deleteContentImportSource({
                source_id: "source_id",
            });
        }).rejects.toThrow(Intercom.UnauthorizedError);
    });
    ...
    test("listExternalPages (1)", async () => {
        ...
        const response = await client.aiContent.listExternalPages();
        expect(response).toEqual({
            type: "list",
            pages: {
                type: "pages",
    ...
    test("listExternalPages (2)", async () => {
        ...
        await expect(async () => {
            return await client.aiContent.listExternalPages();
        }).rejects.toThrow(Intercom.UnauthorizedError);
    });
    ...
    test("createExternalPage (1)", async () => {
        ...
        const response = await client.aiContent.createExternalPage({
            title: "Test",
            html: "<html><body><h1>Test</h1></body></html>",
            url: "https://www.example.com",
            source_id: 44,
    ...
    test("createExternalPage (2)", async () => {
        ...
        await expect(async () => {
            return await client.aiContent.createExternalPage({
                title: "title",
                html: "html",
                source_id: 1,
    ...
    test("getExternalPage (1)", async () => {
        ...
        const response = await client.aiContent.getExternalPage({
            page_id: "page_id",
        });
        expect(response).toEqual({
            type: "external_page",
    ...
    test("getExternalPage (2)", async () => {
        ...
        await expect(async () => {
            return await client.aiContent.getExternalPage({
                page_id: "page_id",
            });
        }).rejects.toThrow(Intercom.UnauthorizedError);
    });
    ...
    test("updateExternalPage (1)", async () => {
        ...
        const response = await client.aiContent.updateExternalPage({
            page_id: "page_id",
            title: "Test",
            html: "<html><body><h1>Test</h1></body></html>",
            url: "https://www.example.com",
    ...
    test("updateExternalPage (2)", async () => {
        ...
        await expect(async () => {
            return await client.aiContent.updateExternalPage({
                page_id: "page_id",
                title: "title",
                html: "html",
                url: "url",
    ...
    test("deleteExternalPage (1)", async () => {
        ...
        const response = await client.aiContent.deleteExternalPage({
            page_id: "page_id",
        });
        expect(response).toEqual({
            type: "external_page",
    ...
    test("deleteExternalPage (2)", async () => {
        ...
        await expect(async () => {
            return await client.aiContent.deleteExternalPage({
                page_id: "page_id",
            });
        }).rejects.toThrow(Intercom.UnauthorizedError);
    });
