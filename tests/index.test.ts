...
import { APIUserAbortError } from 'intercom';
import { Headers } from 'intercom/core';
...
describe('retries', () => {
  test('single retry', async () => {
    ...
    const client = new Intercom({ bearerToken: 'My Bearer Token', timeout: 2000, fetch: testFetch });
