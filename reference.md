...
<details><summary><code>client.admins.<a href="/src/api/resources/admins/client/Client.ts">away</a>(id, { ...params }) -> Intercom.Admin | undefined</code></summary>
<dl>
<dd>
...
**id:** `number` — The unique identifier of a given admin
...
<details><summary><code>client.admins.<a href="/src/api/resources/admins/client/Client.ts">find</a>(id) -> Intercom.Admin | undefined</code></summary>
<dl>
<dd>
...
<details><summary><code>client.articles.<a href="/src/api/resources/articles/client/Client.ts">list</a>() -> Intercom.ArticleList</code></summary>
<dl>
<dd>
...
<details><summary><code>client.articles.<a href="/src/api/resources/articles/client/Client.ts">find</a>(id) -> Intercom.Article</code></summary>
<dl>
<dd>
...
**id:** `number` — The unique identifier for the article which is given by Intercom.
...
<details><summary><code>client.articles.<a href="/src/api/resources/articles/client/Client.ts">update</a>(id, { ...params }) -> Intercom.Article</code></summary>
<dl>
<dd>
...
<details><summary><code>client.articles.<a href="/src/api/resources/articles/client/Client.ts">delete</a>(id) -> Intercom.DeletedArticleObject</code></summary>
<dl>
<dd>
...
<details><summary><code>client.helpCenter.<a href="/src/api/resources/helpCenter/client/Client.ts">find</a>(id) -> Intercom.HelpCenter</code></summary>
<dl>
<dd>
...
**id:** `number` — The unique identifier for the collection which is given by Intercom.
...
<details><summary><code>client.helpCenter.<a href="/src/api/resources/helpCenter/client/Client.ts">list</a>() -> Intercom.HelpCenterList</code></summary>
<dl>
<dd>
...
<details><summary><code>client.helpCenter.collections.<a href="/src/api/resources/helpCenter/resources/collections/client/Client.ts">list</a>() -> Intercom.CollectionList</code></summary>
<dl>
<dd>
...
<details><summary><code>client.helpCenter.collections.<a href="/src/api/resources/helpCenter/resources/collections/client/Client.ts">create</a>({ ...params }) -> Intercom.Collection</code></summary>
<dl>
<dd>
...
<details><summary><code>client.helpCenter.collections.<a href="/src/api/resources/helpCenter/resources/collections/client/Client.ts">find</a>(id) -> Intercom.Collection</code></summary>
<dl>
<dd>
...
<details><summary><code>client.helpCenter.collections.<a href="/src/api/resources/helpCenter/resources/collections/client/Client.ts">update</a>(id, { ...params }) -> Intercom.Collection</code></summary>
<dl>
<dd>
...
<details><summary><code>client.helpCenter.collections.<a href="/src/api/resources/helpCenter/resources/collections/client/Client.ts">delete</a>(id) -> Intercom.DeletedCollectionObject</code></summary>
<dl>
<dd>
...
<details><summary><code>client.companies.<a href="/src/api/resources/companies/client/Client.ts">create</a>({ ...params }) -> Intercom.Company</code></summary>
<dl>
<dd>
...
<details><summary><code>client.companies.<a href="/src/api/resources/companies/client/Client.ts">find</a>(id) -> Intercom.Company</code></summary>
<dl>
<dd>
...
<details><summary><code>client.companies.<a href="/src/api/resources/companies/client/Client.ts">update</a>(id) -> Intercom.Company</code></summary>
<dl>
<dd>
...
<details><summary><code>client.companies.<a href="/src/api/resources/companies/client/Client.ts">delete</a>(id) -> Intercom.DeletedCompanyObject</code></summary>
<dl>
<dd>
...
<details><summary><code>client.companies.<a href="/src/api/resources/companies/client/Client.ts">listAttachedContacts</a>(id) -> Intercom.CompanyAttachedContacts</code></summary>
<dl>
<dd>
...
<details><summary><code>client.companies.<a href="/src/api/resources/companies/client/Client.ts">listAttachedSegments</a>(id) -> Intercom.CompanyAttachedSegments</code></summary>
<dl>
<dd>
...
<details><summary><code>client.companies.<a href="/src/api/resources/companies/client/Client.ts">attachContact</a>(id, { ...params }) -> Intercom.Company</code></summary>
<dl>
<dd>
...
<details><summary><code>client.companies.<a href="/src/api/resources/companies/client/Client.ts">detachContact</a>(contactId, id) -> Intercom.Company</code></summary>
<dl>
<dd>
...
<details><summary><code>client.contacts.<a href="/src/api/resources/contacts/client/Client.ts">listAttachedCompanies</a>(id) -> Intercom.ContactAttachedCompanies</code></summary>
<dl>
<dd>
...
<details><summary><code>client.contacts.<a href="/src/api/resources/contacts/client/Client.ts">listAttachedSegments</a>(contactId) -> Intercom.ContactSegments</code></summary>
<dl>
<dd>
...
<details><summary><code>client.contacts.<a href="/src/api/resources/contacts/client/Client.ts">listAttachedEmailSubscriptions</a>(contactId) -> Intercom.SubscriptionTypeList</code></summary>
<dl>
<dd>
...
<details><summary><code>client.contacts.<a href="/src/api/resources/contacts/client/Client.ts">attachToContact</a>(contactId, { ...params }) -> Intercom.SubscriptionType</code></summary>
<dl>
<dd>
...
<details><summary><code>client.contacts.<a href="/src/api/resources/contacts/client/Client.ts">detachFromContact</a>(contactId, id) -> Intercom.SubscriptionType</code></summary>
<dl>
<dd>
...
<details><summary><code>client.contacts.<a href="/src/api/resources/contacts/client/Client.ts">listAttachedTags</a>(contactId) -> Intercom.TagList</code></summary>
<dl>
<dd>
...
<details><summary><code>client.contacts.<a href="/src/api/resources/contacts/client/Client.ts">find</a>(id) -> Intercom.Contact</code></summary>
<dl>
<dd>
...
<details><summary><code>client.contacts.<a href="/src/api/resources/contacts/client/Client.ts">update</a>(id, { ...params }) -> Intercom.Contact</code></summary>
<dl>
<dd>
...
<details><summary><code>client.contacts.<a href="/src/api/resources/contacts/client/Client.ts">delete</a>(id) -> Intercom.ContactDeleted</code></summary>
<dl>
<dd>
...
<details><summary><code>client.contacts.<a href="/src/api/resources/contacts/client/Client.ts">list</a>() -> Intercom.ContactList</code></summary>
<dl>
<dd>
...
<details><summary><code>client.contacts.<a href="/src/api/resources/contacts/client/Client.ts">archive</a>(id) -> Intercom.ContactArchived</code></summary>
<dl>
<dd>
...
<details><summary><code>client.contacts.<a href="/src/api/resources/contacts/client/Client.ts">unarchive</a>(id) -> Intercom.ContactUnarchived</code></summary>
<dl>
<dd>
...
<details><summary><code>client.notes.<a href="/src/api/resources/notes/client/Client.ts">list</a>(id) -> Intercom.NoteList</code></summary>
<dl>
<dd>
...
**id:** `number` — The unique identifier of a contact.
...
<details><summary><code>client.notes.<a href="/src/api/resources/notes/client/Client.ts">create</a>(id, { ...params }) -> Intercom.Note</code></summary>
<dl>
<dd>
...
**id:** `number` — The unique identifier of a given contact.
...
<details><summary><code>client.notes.<a href="/src/api/resources/notes/client/Client.ts">find</a>(id) -> Intercom.Note</code></summary>
<dl>
<dd>
...
**id:** `number` — The unique identifier of a given note
...
<details><summary><code>client.tags.<a href="/src/api/resources/tags/client/Client.ts">tagContact</a>(contactId, { ...params }) -> Intercom.Tag</code></summary>
<dl>
<dd>
...
<details><summary><code>client.tags.<a href="/src/api/resources/tags/client/Client.ts">untagContact</a>(contactId, id) -> Intercom.Tag</code></summary>
<dl>
<dd>
...
<details><summary><code>client.tags.<a href="/src/api/resources/tags/client/Client.ts">tagConversation</a>(conversationId, { ...params }) -> Intercom.Tag</code></summary>
<dl>
<dd>
...
<details><summary><code>client.tags.<a href="/src/api/resources/tags/client/Client.ts">untagConversation</a>(conversationId, id, { ...params }) -> Intercom.Tag</code></summary>
<dl>
<dd>
...
<details><summary><code>client.tags.<a href="/src/api/resources/tags/client/Client.ts">find</a>(id) -> Intercom.Tag</code></summary>
<dl>
<dd>
...
<details><summary><code>client.tags.<a href="/src/api/resources/tags/client/Client.ts">delete</a>(id) -> void</code></summary>
<dl>
<dd>
...
<details><summary><code>client.tags.<a href="/src/api/resources/tags/client/Client.ts">attach</a>(ticketId, { ...params }) -> Intercom.Tag</code></summary>
<dl>
<dd>
...
<details><summary><code>client.tags.<a href="/src/api/resources/tags/client/Client.ts">detach</a>(ticketId, id, { ...params }) -> Intercom.Tag</code></summary>
<dl>
<dd>
...
<details><summary><code>client.conversations.<a href="/src/api/resources/conversations/client/Client.ts">list</a>({ ...params }) -> Intercom.PaginatedResponse</code></summary>
<dl>
<dd>
...
**request:** `Intercom.ConversationsListRequest`
...
<details><summary><code>client.conversations.<a href="/src/api/resources/conversations/client/Client.ts">find</a>(id, { ...params }) -> Intercom.Conversation</code></summary>
<dl>
<dd>
...
**id:** `number` — The id of the conversation to target
...
**request:** `Intercom.ConversationsFindRequest`
...
<details><summary><code>client.conversations.<a href="/src/api/resources/conversations/client/Client.ts">update</a>(id, { ...params }) -> Intercom.Conversation</code></summary>
<dl>
<dd>
...
<details><summary><code>client.conversations.<a href="/src/api/resources/conversations/client/Client.ts">reply</a>(id, { ...params }) -> Intercom.Conversation</code></summary>
<dl>
<dd>
...
**request:** `Intercom.ReplyConversationRequest`
...
<details><summary><code>client.conversations.<a href="/src/api/resources/conversations/client/Client.ts">manage</a>(id, { ...params }) -> Intercom.Conversation</code></summary>
<dl>
<dd>
...
**request:** `Intercom.ConversationsManageRequestBody`
...
<details><summary><code>client.conversations.<a href="/src/api/resources/conversations/client/Client.ts">assign</a>(id) -> Intercom.Conversation</code></summary>
<dl>
<dd>
...
<details><summary><code>client.conversations.<a href="/src/api/resources/conversations/client/Client.ts">attachContact</a>(id, { ...params }) -> Intercom.Conversation</code></summary>
<dl>
<dd>
...
<details><summary><code>client.conversations.<a href="/src/api/resources/conversations/client/Client.ts">detachContactAsAdmin</a>(conversationId, contactId, { ...params }) -> Intercom.Conversation</code></summary>
<dl>
<dd>
...
<details><summary><code>client.conversations.<a href="/src/api/resources/conversations/client/Client.ts">convertToTicket</a>(id, { ...params }) -> Intercom.Ticket | undefined</code></summary>
<dl>
<dd>
...
<details><summary><code>client.dataAttributes.<a href="/src/api/resources/dataAttributes/client/Client.ts">update</a>(id, { ...params }) -> Intercom.DataAttribute</code></summary>
<dl>
<dd>
...
**id:** `number` — The data attribute id
...
**request:** `Intercom.CreateDataExportsRequest`
...
<details><summary><code>client.dataExport.<a href="/src/api/resources/dataExport/client/Client.ts">find</a>(jobIdentifier) -> Intercom.DataExport</code></summary>
<dl>
<dd>
...
<details><summary><code>client.dataExport.<a href="/src/api/resources/dataExport/client/Client.ts">cancel</a>(jobIdentifier) -> Intercom.DataExport</code></summary>
<dl>
<dd>
...
<details><summary><code>client.dataExport.<a href="/src/api/resources/dataExport/client/Client.ts">download</a>(jobIdentifier) -> void</code></summary>
<dl>
<dd>
...
await client.messages.create({
    ...
    to: {
        type: Intercom.CreateMessageRequestType.User,
...
<details><summary><code>client.news.<a href="/src/api/resources/news/client/Client.ts">listItems</a>() -> Intercom.PaginatedResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.news.<a href="/src/api/resources/news/client/Client.ts">createItem</a>({ ...params }) -> Intercom.NewsItem</code></summary>
<dl>
<dd>
...
<details><summary><code>client.news.<a href="/src/api/resources/news/client/Client.ts">findItem</a>(id) -> Intercom.NewsItem</code></summary>
<dl>
<dd>
...
**id:** `number` — The unique identifier for the news item which is given by Intercom.
...
<details><summary><code>client.news.<a href="/src/api/resources/news/client/Client.ts">updateItem</a>(id, { ...params }) -> Intercom.NewsItem</code></summary>
<dl>
<dd>
...
<details><summary><code>client.news.<a href="/src/api/resources/news/client/Client.ts">deleteItem</a>(id) -> Intercom.DeletedObject</code></summary>
<dl>
<dd>
...
<details><summary><code>client.news.<a href="/src/api/resources/news/client/Client.ts">listLiveItems</a>(id) -> Intercom.PaginatedResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.news.<a href="/src/api/resources/news/client/Client.ts">list</a>() -> Intercom.PaginatedResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.news.<a href="/src/api/resources/news/client/Client.ts">find</a>(id) -> Intercom.Newsfeed</code></summary>
<dl>
<dd>
...
**request:** `Intercom.SegmentsListRequest`
...
<details><summary><code>client.segments.<a href="/src/api/resources/segments/client/Client.ts">find</a>(id) -> Intercom.Segment</code></summary>
<dl>
<dd>
...
<details><summary><code>client.subscriptions.<a href="/src/api/resources/subscriptions/client/Client.ts">listTypes</a>() -> Intercom.SubscriptionTypeList</code></summary>
<dl>
<dd>
...
<details><summary><code>client.phoneCallRedirect.<a href="/src/api/resources/phoneCallRedirect/client/Client.ts">create</a>({ ...params }) -> Intercom.PhoneSwitch | undefined</code></summary>
<dl>
<dd>
...
```typescript
await client.phoneCallRedirect.create({
    phone: "+353832345678",
    custom_attributes: {
        issue_type: "Billing",
        priority: "High",
...
**requestOptions:** `PhoneCallRedirect.RequestOptions`
...
<details><summary><code>client.teams.<a href="/src/api/resources/teams/client/Client.ts">find</a>(id) -> Intercom.Team</code></summary>
<dl>
<dd>
...
<details><summary><code>client.ticketTypeAttributes.<a href="/src/api/resources/ticketTypeAttributes/client/Client.ts">create</a>(ticketTypeId, { ...params }) -> Intercom.TicketTypeAttribute | undefined</code></summary>
<dl>
<dd>
...
<details><summary><code>client.ticketTypeAttributes.<a href="/src/api/resources/ticketTypeAttributes/client/Client.ts">update</a>(ticketTypeId, id, { ...params }) -> Intercom.TicketTypeAttribute | undefined</code></summary>
<dl>
<dd>
...
<details><summary><code>client.ticketTypes.<a href="/src/api/resources/ticketTypes/client/Client.ts">get</a>(id) -> Intercom.TicketType | undefined</code></summary>
<dl>
<dd>
...
<details><summary><code>client.ticketTypes.<a href="/src/api/resources/ticketTypes/client/Client.ts">update</a>(id, { ...params }) -> Intercom.TicketType | undefined</code></summary>
<dl>
<dd>
...
<details><summary><code>client.tickets.<a href="/src/api/resources/tickets/client/Client.ts">reply</a>(id, { ...params }) -> Intercom.TicketReply</code></summary>
<dl>
<dd>
...
```typescript
await client.tickets.reply("123", {
    message_type: "comment",
    type: "user",
    body: "Thanks again :)",
...
**request:** `Intercom.TicketsReplyRequestBody`
...
<details><summary><code>client.tickets.<a href="/src/api/resources/tickets/client/Client.ts">get</a>(id) -> Intercom.Ticket | undefined</code></summary>
<dl>
<dd>
...
<details><summary><code>client.tickets.<a href="/src/api/resources/tickets/client/Client.ts">update</a>(id, { ...params }) -> Intercom.Ticket | undefined</code></summary>
<dl>
<dd>
...
```typescript
await client.tickets.update("id", {
    ticket_attributes: {
        _default_title_: "example",
        _default_description_: "there is a problem",
    },
