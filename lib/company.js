...
export default class Company {
  ...
  find(params) {
    if (params.id) {
      ...
      return this.client.get({url: '/companies', data: { company_id: params.company_id }});
    } else if (params.name) {
      return this.client.get({url: '/companies', data: { name: params.name }});
    }
  }
  listUsers(params) {
    if (params.id) {
      ...
      return this.client.get({url: '/companies', data: { company_id: params.company_id, type: 'user' }, });
    } else if (params.name) {
      return this.client.get({url: '/companies', data: { name: params.name, type: 'user' }, });
    }
  }
}
