...
export default class Company {
  ...
  delete(params, f) {
    if (params.id) {
      return this.client.delete(`/companies/${params.id}`, {}, f);
    } else if (params.company_id) {
      return this.client.delete(`/companies`, { company_id: params.company_id }, f);
    } else if (params.name) {
      return this.client.delete(`/companies`, { name: params.name }, f);
    }
  }
  listUsers(params, f) {
    if (params.id) {
