...
export default class Admin {
  ...
  const data = {
   ...
   return this.client.put<AdminObject>({url: `/${this.baseUrl}/${adminId}/away`, data})
  }
  listAllActivityLogs({before, after}: IListAllActivityLogsData) {
    ...
    return this.client.get<IListAllActivityLogsResponse>({url: `/${this.baseUrl}/activity_logs`, data});
  }
  list() {
