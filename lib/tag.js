...
var Tag = /** @class */ (function () {
    ...
    Tag.prototype.tagContact = function (_a) {
        ...
        return this.client.post({
            url: '/'
                .concat(this.client.contacts.baseUrl, '/')
                .concat(contactId, '/')
                .concat(this.tagsBaseUrl),
            data: data,
        });
    };
    Tag.prototype.tagConversation = function (_a) {
        ...
        return this.client.post({
            url: '/'
                .concat(this.client.conversations.baseUrl, '/')
    ...
    Tag.prototype.tagCompanies = function (_a) {
        var name = _a.name,
            companiesIds = _a.companiesIds;
        var data = {
            name: name,
            companies: companiesIds.map(function (id) {
                return { id: id };
            }),
        };
        return this.client.post({
