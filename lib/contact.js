...
var Contact = /** @class */ (function () {
    ...
    Contact.prototype.list = function (_a) {
        ...
        return this.client.get({ url: "/".concat(this.contactBaseUrl), data: queryData });
    };
    ...
    Contact.prototype.listAttachedCompanies = function (_a) {
        ...
        return this.client.get({ url: "/".concat(this.contactBaseUrl, "/").concat(id, "/companies"), data: queryData });
    };
