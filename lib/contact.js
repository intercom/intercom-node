...
var Contact = /** @class */ (function () {
    ...
    Contact.prototype.createUser = function (_a) {
        ...
        return this.client.post({ url: "/" + this.contactBaseUrl, data: requestData });
    };
    ...
    Contact.prototype.find = function (_a) {
        var id = _a.id;
        return this.client.get({ url: "/" + this.contactBaseUrl + "/" + id });
        ;
    };
    Contact.prototype.update = function (_a) {
        ...
        return this.client.put({ url: "/" + this.contactBaseUrl + "/" + id, data: data });
    };
    Contact.prototype.mergeLeadInUser = function (_a) {
        ...
        return this.client.post({ url: "/" + this.contactBaseUrl + "/merge", data: data });
    };
    Contact.prototype.search = function (_a) {
        var data = _a.data;
        return this.client.post({ url: "/" + this.contactBaseUrl + "/search", data: data });
    };
    Contact.prototype.list = function () {
        return this.client.get({ url: "/" + this.contactBaseUrl });
    };
    Contact.prototype.delete = function (_a) {
        var id = _a.id;
        return this.client.delete({ url: "/" + this.contactBaseUrl + "/" + id });
        ;
    };
    Contact.prototype.archive = function (_a) {
        var id = _a.id;
        return this.client.post({ url: "/" + this.contactBaseUrl + "/" + id + "/archive" });
        ;
    };
    Contact.prototype.unarchive = function (_a) {
        var id = _a.id;
        return this.client.post({ url: "/" + this.contactBaseUrl + "/" + id + "/unarchive" });
        ;
    };
    Contact.prototype.listAttachedCompanies = function (_a) {
        var id = _a.id;
        return this.client.get({ url: "/" + this.contactBaseUrl + "/" + id + "/companies" });
        ;
    };
    Contact.prototype.listAttachedTags = function (_a) {
        var id = _a.id;
        return this.client.get({ url: "/" + this.contactBaseUrl + "/" + id + "/tags" });
        ;
    };
    Contact.prototype.listAttachedSegments = function (_a) {
        var id = _a.id;
        return this.client.get({ url: "/" + this.contactBaseUrl + "/" + id + "/segments" });
        ;
    };
    Contact.prototype.listAttachedEmailSubscriptions = function (_a) {
        var id = _a.id;
        return this.client.get({ url: "/" + this.contactBaseUrl + "/" + id + "/subscriptions" });
        ;
    };
    return Contact;
}());
