...
var Contact = /** @class */ (function () {
    ...
    Contact.prototype.createUser = function (_a) {
        var externalId = _a.externalId,
            ...
            name = _a.name,
            avatar = _a.avatar,
            signedUpAt = _a.signedUpAt,
            lastSeenAt = _a.lastSeenAt,
            ownerId = _a.ownerId,
            isUnsubscribedFromEmails = _a.isUnsubscribedFromEmails,
    ...
    Contact.prototype.createLead = function (data) {
        var requestData = {
            ...
            signed_up_at:
                data === null || data === void 0 ? void 0 : data.signedUpAt,
            last_seen_at:
                data === null || data === void 0 ? void 0 : data.lastSeenAt,
            owner_id: data === null || data === void 0 ? void 0 : data.ownerId,
            unsubscribed_from_emails:
                data === null || data === void 0
                    ? void 0
                    : data.isUnsubscribedFromMails,
            custom_attributes:
                data === null || data === void 0
                    ? void 0
    ...
    Contact.prototype.update = function (_a) {
        var id = _a.id,
            ...
            lastSeenAt = _a.lastSeenAt,
            ownerId = _a.ownerId,
            isUnsubscribedFromMails = _a.isUnsubscribedFromMails,
            customAttributes = _a.customAttributes;
        var data = {
            role: role,
            external_id: externalId,
    ...
    Contact.prototype.list = function (_a) {
        var perPage = _a.perPage,
            startingAfter = _a.startingAfter;
        var queryData = {
            per_page: perPage,
...
(function (SearchContactOrderBy) {
    ...
    (SearchContactOrderBy =
        exports.SearchContactOrderBy || (exports.SearchContactOrderBy = {}))
);
