...
export default class Client {
  ...
  request(args, callback) {
    ...
    // Append methods arguments
    args = Object.assign({}, defaultArgs, args);
    // Arguements to finally use for request
    const requestArgs = Object.assign({}, this.requestOpts);
    // Don't just use Object.assign(requestArgs, args) here because we need to handle special cases like .headers
    for (const argName in args) {
      switch (argName) {
        case 'headers':
          // Merge in these values
          requestArgs[argName] = Object.assign({}, requestArgs[argName], args[argName]);
          break;
        default:
          requestArgs[argName] = args[argName];
          break;
      }
    }
