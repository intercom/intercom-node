...
var Client = /** @class */ (function () {
    ...
    Client.prototype.initiateAxiosInstance = function () {
        ...
        var axiosInstance = axios_1.default.create({ headers: defaultHeaders, auth: { username: this.usernamePart, password: this.passwordPart }, baseURL: this.requestOpts.baseURL });
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.axiosInstance.delete(url, { params: data })];
                    case 1:
                        response = _b.sent();
                        this.checkOnErrorInResponse(response);
                        return [2 /*return*/, response];
    ...
    Client.prototype.checkOnErrorInResponse = function (_a) {
        ...
        throw new badResponse_error_1.BadResponseError(message || 'Response error', data, headers, status);
    };
    return Client;
}());
