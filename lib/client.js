...
var Client = /** @class */ (function () {
    ...
    function Client() {
        ...
        this.usebaseURL = (0, util_1.deprecate)(function (baseURL) {
    ...
    Client.prototype.initiateAxiosInstance = function () {
        ...
        var axiosInstance = axios_1.default.create({
            auth: { username: this.usernamePart, password: this.passwordPart },
            baseURL: this.requestOpts.baseURL,
        });
        axiosInstance.defaults.headers.common = (0, lodash_1.merge)(
    ...
    Client.prototype.updateAxiosInstanceDefaults = function () {
        this.axiosInstance.defaults = (0, lodash_1.merge)(
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            this.axiosInstance.get(url, { params: data }),
                        ];
                    case 1:
                        response = _b.sent();
                        return [2 /*return*/, response.data];
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            this.axiosInstance.get(paginationObject.next, {
                                baseURL: undefined,
                            }),
                        ];
                    case 1:
    ...
    Client.prototype.checkOnErrorInResponse = function (_a) {
        ...
        var message =
            Array.isArray(data.errors) && data.errors[0].message
                ...
                : null;
        return new badResponse_error_1.BadResponseError(
