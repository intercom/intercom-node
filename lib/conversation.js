...
var Conversation = /** @class */ (function () {
    ...
    Conversation.prototype.find = function (_a) {
        ...
        return this.client.get({ url: "/".concat(this.baseUrl, "/").concat(id), data: data });
    };
    ...
    Conversation.prototype.replyByIdAsUser = function (_a) {
        ...
        return this.client.post({ url: "/".concat(this.baseUrl, "/").concat(id, "/reply"), data: data });
    };
    ...
    Conversation.prototype.replyByLastAsUser = function (_a) {
        ...
        return this.client.post({ url: "/".concat(this.baseUrl, "/last/reply"), data: data });
    };
    ...
    Conversation.prototype.close = function (_a) {
        ...
        return this.client.post({ url: "/".concat(this.baseUrl, "/").concat(id, "/parts"), data: data });
    };
    ...
    Conversation.prototype.attachContactAsAdmin = function (_a) {
        ...
        return this.client.post({ url: "/".concat(this.baseUrl, "/").concat(id, "/customers"), data: data });
    };
    ...
    Conversation.prototype.detachContactAsAdmin = function (_a) {
        ...
        return this.client.delete({ url: "/".concat(this.baseUrl, "/").concat(conversationId, "/customers/").concat(contactId), data: data });
    };
    ...
    Conversation.prototype.list = function (_a) {
        var query = _a.query;
        return this.client.get({ url: "/".concat(this.baseUrl), data: query });
    };
    Conversation.prototype.redactConversationPart = function (_a) {
        ...
        return this.client.post({ url: "/".concat(this.baseUrl, "/redact"), data: data });
    };
    return Conversation;
}());
