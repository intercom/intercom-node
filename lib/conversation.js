...
var Conversation = /** @class */ (function () {
    ...
    Conversation.prototype.create = function (_a) {
        ...
        return this.client.post({ url: "/" + this.conversationBaseUrl, data: requestData });
    };
    Conversation.prototype.find = function (_a) {
        ...
        return this.client.get({ url: "/" + this.conversationBaseUrl + "/" + id, data: data });
        ;
    };
