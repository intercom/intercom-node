...
exports.RedactConversationPartType =
    exports.SortBy =
    exports.Order =
    exports.SearchConversationOrderBy =
    exports.OpenConversationMessageType =
    exports.CloseConversationType =
    exports.CloseConversationMessageType =
    exports.SnoozeConversationMessageType =
    exports.AssignToConversationUserType =
    exports.AssignToConversationMessageType =
    exports.ReplyToConversationUserType =
    exports.ReplyToConversationMessageType =
        void 0;
var Conversation = /** @class */ (function () {
    ...
    Conversation.prototype.update = function (_a) {
        var id = _a.id,
            markRead = _a.markRead,
            customAttributes = _a.customAttributes;
        var data = {
            read: markRead,
    ...
    Conversation.prototype.replyByIdAsUser = function (_a) {
        var id = _a.id,
            body = _a.body,
            intercomUserId = _a.intercomUserId,
            userId = _a.userId,
            email = _a.email,
            attachmentUrls = _a.attachmentUrls;
        var data = {
    ...
    Conversation.prototype.assign = function (_a) {
        var id = _a.id,
            type = _a.type,
            adminId = _a.adminId,
            assigneeId = _a.assigneeId,
            body = _a.body,
            _b = _a.withRunningAssignmentRules,
            withRunningAssignmentRules = _b === void 0 ? false : _b;
        var url = '/'
            .concat(this.baseUrl, '/')
            .concat(id)
            .concat(
    ...
    Conversation.prototype.list = function (_a) {
        ...
        return this.client.get({ url: '/'.concat(this.baseUrl), data: data });
    };
    Conversation.prototype.redactConversationPart = function (_a) {
        var conversationId = _a.conversationId,
            conversationPartId = _a.conversationPartId,
...
(function (CloseConversationType) {
    ...
    (CloseConversationType =
        exports.CloseConversationType || (exports.CloseConversationType = {}))
);
//
