...
export default class User {
  ...
  listBy(params) {
    return this.client.get({url: '/users', data: params});
  }
  find(params) {
    if (params.id) {
    ...
    if (params.user_id) {
      return this.client.get({url: '/users', data: { user_id: params.user_id }});
    }

    if (params.email) {
      return this.client.get({url: '/users', data: { email: params.email }});
    }
  }
  archive(params) {
    if (params.id) {
    ...
    if (params.user_id) {
      return this.client.delete({url: '/users', params: { user_id: params.user_id }});
    }

    if (params.email) {
      return this.client.delete({url: '/users', params: { email: params.email }});
    }
  }
  bulk(params) {
  ...
  requestPermanentDeletion(intercom_user_id) {
    return this.client.post({url: '/user_delete_requests', data: { intercom_user_id }});
  }
  requestPermanentDeletionByParams(params) {
    ...
    return this.find(params)
      .then((res) => this.requestPermanentDeletion(res.data.id));
  }
}
