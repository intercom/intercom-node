...
export class Teams {
     ...
     */
    public listTeams(requestOptions?: Teams.RequestOptions): core.HttpResponsePromise<Intercom.unstable.TeamList> {
    ...
    private async __retrieveTeam(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.IntercomTimeoutError("Timeout exceeded when calling GET /teams/{id}.");
            case "unknown":
                throw new errors.IntercomError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
