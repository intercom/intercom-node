...
export class Brands {
     ...
     */
    public listBrands(requestOptions?: Brands.RequestOptions): core.HttpResponsePromise<Intercom.unstable.BrandList> {
    ...
    private async __listBrands(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.IntercomTimeoutError("Timeout exceeded when calling GET /brands.");
            case "unknown":
                throw new errors.IntercomError({
    ...
    private async __retrieveBrand(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.IntercomTimeoutError("Timeout exceeded when calling GET /brands/{id}.");
            case "unknown":
                throw new errors.IntercomError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
