...
export class Tickets {
     ...
     *
     * @param {string} id
     * @param {Intercom.TicketsReplyRequestBody} request
     ...
     * @example
     *     await client.tickets.reply("123", {
     *         message_type: Intercom.AdminReplyTicketRequestMessageType.Note,
     *         type: "admin",
     ...
     * @example
     *     await client.tickets.reply("123", {
     *         message_type: Intercom.AdminReplyTicketRequestMessageType.QuickReply,
     *         type: "admin",
     *         admin_id: "3156780",
     *         reply_options: [{
     *                 text: "Yes",
     ...
     *
     * @param {string} id - The unique identifier for the ticket which is given by Intercom.
     * @param {Tickets.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Intercom.UnauthorizedError}
     *
     ...
     */
    public async get(id: string, requestOptions?: Tickets.RequestOptions): Promise<Intercom.Ticket | undefined> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.IntercomEnvironment.UsProduction,
