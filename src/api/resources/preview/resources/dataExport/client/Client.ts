...
export class DataExportClient {
     ...
     *
     * @param {Intercom.preview.CreateDataExportsRequest} request
    ...
    ): core.HttpResponsePromise<Intercom.preview.DataExport> {
    ...
    private async __createDataExport(
        request: Intercom.preview.CreateDataExportsRequest,
        requestOptions?: DataExportClient.RequestOptions,
    ): Promise<core.WithRawResponse<Intercom.preview.DataExport>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Intercom.preview.DataExport, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {Intercom.preview.GetDataExportRequest} request
     * @param {DataExportClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {Intercom.preview.CancelDataExportRequest} request
     * @param {DataExportClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     ...
     *
     * @param {Intercom.preview.DownloadDataExportRequest} request
     * @param {DataExportClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
