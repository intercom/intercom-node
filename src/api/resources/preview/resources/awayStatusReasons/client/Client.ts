...
export class AwayStatusReasonsClient {
    ...
    ): core.HttpResponsePromise<Intercom.preview.AwayStatusReason[]> {
    ...
    private async __listAwayStatusReasons(
        requestOptions?: AwayStatusReasonsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Intercom.preview.AwayStatusReason[]>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Intercom.preview.AwayStatusReason[], rawResponse: _response.rawResponse };
        }
