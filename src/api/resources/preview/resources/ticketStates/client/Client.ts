...
export class TicketStatesClient {
    ...
    ): core.HttpResponsePromise<Intercom.preview.TicketStateList> {
        return core.HttpResponsePromise.fromPromise(this.__listTicketStates(requestOptions));
    }

    private async __listTicketStates(
        requestOptions?: TicketStatesClient.RequestOptions,
    ): Promise<core.WithRawResponse<Intercom.preview.TicketStateList>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Intercom.preview.TicketStateList, rawResponse: _response.rawResponse };
        }
