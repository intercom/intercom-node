...
export class DataEventsClient {
     ...
     *
     * @param {Intercom.preview.LisDataEventsRequest} request
    ...
    ): core.HttpResponsePromise<Intercom.preview.DataEventSummary> {
    ...
    private async __lisDataEvents(
        request: Intercom.preview.LisDataEventsRequest,
        requestOptions?: DataEventsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Intercom.preview.DataEventSummary>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Intercom.preview.DataEventSummary, rawResponse: _response.rawResponse };
        }
     ...
     *
     *
     * @param {Intercom.preview.CreateDataEventSummariesRequest} request
     * @param {DataEventsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Intercom.preview.UnauthorizedError}
     *
