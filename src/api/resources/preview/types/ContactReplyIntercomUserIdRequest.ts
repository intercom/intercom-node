 ...
 */
export interface ContactReplyIntercomUserIdRequest extends Intercom.preview.ContactReplyBaseRequest {
    /** The identifier for the contact as given by Intercom. */
    intercom_user_id: string;
    /** A list of files that will be added as attachments. */
    attachment_files?: Intercom.preview.ConversationAttachmentFiles[];
}
