...
export interface ConversationPart {
    ...
    assigned_to?: Intercom.preview.Reference;
    author?: Intercom.preview.ConversationPartAuthor;
    /** A list of attachments for the part. */
    attachments?: Intercom.preview.PartAttachment[];
    /** The external id of the conversation part */
    external_id?: string;
    /** Whether or not the conversation part has been redacted. */
    redacted?: boolean;
    email_message_metadata?: Intercom.preview.EmailMessageMetadata;
    metadata?: Intercom.preview.ConversationPartMetadata;
    ...
    tags?: Intercom.preview.TagBasic[];
    event_details?: Intercom.preview.EventDetails;
