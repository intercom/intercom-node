...
export class FinAgentClient {
     ...
     *
     * @param {Intercom.StartFinConversationRequest} request
    ...
    ): core.HttpResponsePromise<Intercom.StartFinConversationResponse> {
    ...
    private async __startFinConversation(
        request: Intercom.StartFinConversationRequest,
        requestOptions?: FinAgentClient.RequestOptions,
    ): Promise<core.WithRawResponse<Intercom.StartFinConversationResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Intercom.StartFinConversationResponse,
     ...
     * {% /admonition %}
     *
     * @param {Intercom.ReplyToFinRequest} request
     * @param {FinAgentClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Intercom.BadRequestError}
     * @throws {@link Intercom.UnauthorizedError}
    ...
    public replyToFin(
        ...
        requestOptions?: FinAgentClient.RequestOptions,
    ): core.HttpResponsePromise<Intercom.ReplyToFinResponse> {
    ...
    private async __replyToFin(
        request: Intercom.ReplyToFinRequest,
        requestOptions?: FinAgentClient.RequestOptions,
    ): Promise<core.WithRawResponse<Intercom.ReplyToFinResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return { data: _response.body as Intercom.ReplyToFinResponse, rawResponse: _response.rawResponse };
        }
