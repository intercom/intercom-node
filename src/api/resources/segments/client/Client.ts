...
export class Segments {
     ...
     *
     * @param {Intercom.SegmentsListRequest} request
     ...
     *
     * @param {string} id - The unique identified of a given segment.
     * @param {Segments.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Intercom.UnauthorizedError}
     ...
     */
    public async find(id: string, requestOptions?: Segments.RequestOptions): Promise<Intercom.Segment> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.IntercomEnvironment.UsProduction,
