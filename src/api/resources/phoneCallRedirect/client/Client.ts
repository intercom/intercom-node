...
export declare namespace PhoneCallRedirect {
    interface Options {
...
export class PhoneCallRedirect {
    constructor(protected readonly _options: PhoneCallRedirect.Options = {}) {}
     ...
     * @param {PhoneCallRedirect.RequestOptions} requestOptions - Request-specific configuration.
     *
