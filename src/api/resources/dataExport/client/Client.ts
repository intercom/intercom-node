...
export class DataExport {
     ...
     */
    public async find(jobIdentifier: string, requestOptions?: DataExport.RequestOptions): Promise<Intercom.DataExport> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.IntercomEnvironment.UsProduction,
     ...
     */
    public async download(jobIdentifier: string, requestOptions?: DataExport.RequestOptions): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.IntercomEnvironment.UsProduction,
