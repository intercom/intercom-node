...
describe('scroll', () => {
    it('should get users with scroll', async () => {
        nock('https://api.intercom.io')
            ...
            .reply(200, {
                ...
                users: [dummyUsers.dummyUser],
            });

        nock('https://api.intercom.io')
            .get('/users/scroll?scroll_param=123_soleil')
            .reply(200, {
                type: 'user.list',
                scroll_param: '123_soleil',
                users: [],
    ...
    it('should return a promise that resolves at the end of the scroll', async () => {
        ...
        nock('https://api.intercom.io')
            .get('/users/scroll?scroll_param=456_crimea')
            .reply(200, {
                type: 'user.list',
                scroll_param: '456_crimea',
                users: [],
        ...
        assert.deepStrictEqual(
            [
                dummyUsers.dummierUser,
                dummyUsers.dummiestUser,
