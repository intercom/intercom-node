...
describe('tags', function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            client.tags.update({ id: '123', name: 'haven' }),
                        ];
                    case 1:
                        response = _a.sent();
                        assert_1.default.deepStrictEqual({}, response);
    ...
    it('should delete tags', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
    ...
    it('should tag contacts', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        (0, nock_1.default)('https://api.intercom.io')
                            .post(
                                '/contacts/'.concat(contactId, '/tags'),
                                requestBody
                            )
                            .reply(200, {});
                        client = new lib_1.Client('foo', 'bar');
    ...
    it('should tag conversations', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
    ...
    it('should tag companies', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var requestBody, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
    ...
    it('should untag contacts', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
    ...
    it('should untag conversations', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
    ...
    it('should untag companies', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var requestBody, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
