        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    (0, nock_1.default)('https://api.intercom.io').post('/messages', requestBody).reply(200, {});
                    client = new lib_1.Client('foo', 'bar');
                    return [4 /*yield*/, client.messages.create({ messageType: requestBody.message_type, subject: requestBody.subject, body: requestBody.body, template: requestBody.template, from: requestBody.from, to: requestBody.to })];
                case 1:
                    response = _a.sent();
