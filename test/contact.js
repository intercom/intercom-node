...
describe('contacts', function () {
    it('should create a contact with user role', function () {
                        ...
                        return [
                            ...
                            client.contacts.createUser({
                                ...
                                isUnsubscribedFromEmails:
                                    contact.unsubscribed_from_emails,
                            }),
                        ];
                    case 1:
                        response = _a.sent();
    ...
    it('should create a contact with lead role', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
    ...
    it('should retrieve a contact by id', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        expectedReply = {};
                        (0, nock_1.default)('https://api.intercom.io')
                            .put('/contacts/'.concat(id), requestBody)
                            .reply(200, expectedReply);
                        client = new lib_1.Client('foo', 'bar');
                        return [
                            4 /*yield*/,
    ...
    it('should archive a contact by id', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id, expectedReply, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        expectedReply = {};
                        (0, nock_1.default)('https://api.intercom.io')
                            .post('/contacts/'.concat(id, '/archive'))
                            .reply(200, expectedReply);
                        client = new lib_1.Client('foo', 'bar');
                        return [
                            4 /*yield*/,
                            client.contacts.archive({ id: id }),
                        ];
                    case 1:
                        response = _a.sent();
                        assert_1.default.deepStrictEqual(
    ...
    it('should unarchive a contact by id', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id, expectedReply, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        expectedReply = {};
                        (0, nock_1.default)('https://api.intercom.io')
                            .post('/contacts/'.concat(id, '/unarchive'))
                            .reply(200, expectedReply);
                        client = new lib_1.Client('foo', 'bar');
                        return [
                            4 /*yield*/,
                            client.contacts.unarchive({ id: id }),
                        ];
                    case 1:
                        response = _a.sent();
                        assert_1.default.deepStrictEqual(
    ...
    it('should merge two contacts', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
    ...
    it('should search for contacts using filters, sorts ascending by name, paginates 5 pages per page on page 2', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
    ...
    it('should list all contacts, with per page = 5 and cursor set to next page', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
    ...
    it('should list attached companies of contact by id', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id, expectedReply, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
    ...
    it('should list attached tags of contact by id', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id, expectedReply, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        expectedReply = {};
                        (0, nock_1.default)('https://api.intercom.io')
                            .get('/contacts/'.concat(id, '/tags'))
                            .reply(200, expectedReply);
                        client = new lib_1.Client('foo', 'bar');
                        return [
                            4 /*yield*/,
                            client.contacts.listAttachedTags({ id: id }),
                        ];
                    case 1:
                        response = _a.sent();
                        assert_1.default.deepStrictEqual(
    ...
    it('should list attached segments of contact by id', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id, expectedReply, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        expectedReply = {};
                        (0, nock_1.default)('https://api.intercom.io')
                            .get('/contacts/'.concat(id, '/segments'))
                            .reply(200, expectedReply);
                        client = new lib_1.Client('foo', 'bar');
                        return [
                            4 /*yield*/,
                            client.contacts.listAttachedSegments({ id: id }),
                        ];
                    case 1:
                        response = _a.sent();
                        assert_1.default.deepStrictEqual(
    ...
    it('should list attached email subscriptions of contact by id', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id, expectedReply, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        expectedReply = {};
                        (0, nock_1.default)('https://api.intercom.io')
                            .get('/contacts/'.concat(id, '/subscriptions'))
                            .reply(200, expectedReply);
                        client = new lib_1.Client('foo', 'bar');
                        return [
                            4 /*yield*/,
                            client.contacts.listAttachedEmailSubscriptions({
                                id: id,
                            }),
                        ];
                    case 1:
