...
describe('conversations', function () {
    ...
    it('should retrieve a conversation as is', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
    ...
    it('should retrieve a conversation as plain text', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id, expectedReply, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
    ...
    it('should update a conversation', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        expectedReply = {};
                        (0, nock_1.default)('https://api.intercom.io')
                            .put('/conversations/'.concat(id), requestBody)
                            .reply(200, expectedReply);
                        client = new lib_1.Client('foo', 'bar');
                        return [
                            4 /*yield*/,
    ...
    it('should reply as user to a conversation by id', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        userRequestBody = {
                            message_type:
                                conversation_1.ReplyToConversationMessageType
                                    .COMMENT,
                            type: conversation_1.ReplyToConversationUserType
                                .USER,
                            body: 'blablbalba',
                            intercom_user_id: id,
                            attachment_urls: [
                                'https://definitely-sfw-site.org/bebra.jpg',
                            ],
                        };
                        expectedReply = {};
                        (0, nock_1.default)('https://api.intercom.io')
                            .post(
                                '/conversations/'.concat(id, '/reply'),
                                userRequestBody
                            )
                            .reply(200, expectedReply);
                        client = new lib_1.Client('foo', 'bar');
                        return [
                            4 /*yield*/,
                            client.conversations.replyByIdAsUser({
                                id: id,
                                body: userRequestBody.body,
                                intercomUserId:
                                    userRequestBody.intercom_user_id,
    ...
    it('should reply as admin to a conversation by id', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            client.conversations.replyByIdAsAdmin({
                                id: id,
                                adminId: adminId,
                                messageType: adminRequestBody.message_type,
                                body: adminRequestBody.body,
                                attachmentUrls:
                                    adminRequestBody.attachment_urls,
                            }),
                        ];
                    case 1:
                        response = _a.sent();
    ...
    it('should reply as user to last conversation', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id, userRequestBody, expectedReply, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            client.conversations.replyByLastAsUser({
                                body: userRequestBody.body,
                                intercomUserId:
                                    userRequestBody.intercom_user_id,
                                attachmentUrls: userRequestBody.attachment_urls,
    ...
    it('should reply as admin to last conversation', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            client.conversations.replyByLastAsAdmin({
                                adminId: adminId,
                                messageType: adminRequestBody.message_type,
                                body: adminRequestBody.body,
                                attachmentUrls:
    ...
    it('should assign a conversation as team without assignment_rules', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id, userRequestBody, expectedReply, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        userRequestBody = {
                            message_type:
                                conversation_1.AssignToConversationMessageType
                                    .ASSIGNMENT,
                            type: conversation_1.AssignToConversationUserType
                                .TEAM,
                            assignee_id: id,
                            admin_id: id,
                            body: '<b>blablbalba</b>',
    ...
    it('should assign a conversation as team with assignment_rules', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id, expectedReply, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
    ...
    it('should snooze a conversation', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        adminRequestBody = {
                            message_type:
                                conversation_1.SnoozeConversationMessageType
                                    .SNOOZED,
                            admin_id: id,
    ...
    it('should close a conversation', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id, adminRequestBody, expectedReply, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        adminRequestBody = {
                            message_type:
                                conversation_1.CloseConversationMessageType
                                    .CLOSED,
    ...
    it('should open a conversation', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id, adminRequestBody, expectedReply, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        adminRequestBody = {
                            message_type:
                                conversation_1.OpenConversationMessageType.OPEN,
                            admin_id: id,
                        };
                        expectedReply = {};
                        (0, nock_1.default)('https://api.intercom.io')
    ...
    it('should attach a contact to the conversation as admin', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id, adminRequestBody, expectedReply, client, response;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        (0, nock_1.default)('https://api.intercom.io')
                            .post(
                                '/conversations/'.concat(id, '/customers'),
                                adminRequestBody
                            )
                            .reply(200, expectedReply);
                        client = new lib_1.Client('foo', 'bar');
    ...
    it('should attach a contact to the conversation as contact', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            client.conversations.attachContactAsContact({
                                id: id,
                                userId: contactRequestBody.user_id,
                                customer: {
                                    intercomUserId:
                                        contactRequestBody.customer
                                            .intercom_user_id,
                                },
                            }),
                        ];
    ...
    it('should detach a contact from the conversation as admin', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var id,
                contactId,
                conversationId,
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        (0, nock_1.default)('https://api.intercom.io')
                            .delete(
                                '/conversations/'
                                    .concat(conversationId, '/customers/')
                                    .concat(contactId),
                                adminRequestBody
                            )
                            .reply(200, expectedReply);
    ...
    it('should search for conversations using filters', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        (0, nock_1.default)('https://api.intercom.io')
                            .get(
                                '/conversations?order=desc&sort=updated_at&page=1&per_page=10'
                            )
                            .reply(200, expectedReply);
                        client = new lib_1.Client('foo', 'bar');
                        return [
                            ...
                            client.conversations.list({
                                query: {
                                    order: conversation_1.Order.DESC,
                                    sort: conversation_1.SortBy.UpdatedAt,
                                    page: 1,
                                    perPage: 10,
                                },
                            }),
    ...
    it('should redact a conversation part', function () {
        return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
            var conversation_id,
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestBody = {
                            type: conversation_1.RedactConversationPartType
                                .CONVERSATION_PART,
                        ...
                        return [
                            ...
                            client.conversations.redactConversationPart({
                                ...
                                conversationPartId:
                                    requestBody.conversation_part_id,
                            }),
                        ];
                    case 1:
                        response = _a.sent();
